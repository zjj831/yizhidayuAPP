...
<head>
    ...
    <link rel="stylesheet" href="/test/Public/Activity/66_tiger_new/css/index_002.css">
...
<body>
<div class="content">
    <section style="background-image:url(https://yun.yizhidayu.com/66-tiger-newbbj.jpg);background-size:100% 100%;background-repeat: no-repeat;">
        <!--/****红包雨-->
        ...
        <!--/**闲杂按钮**/-->
        <img src="https://yun.yizhidayu.com/66-tiger-xiaoxiong.gif" alt="" class="panda">
        <img src="https://yun.yizhidayu.com/66-tiger-title2.png" alt="" class="title">
        <img src="https://yun.yizhidayu.com/66-tiger-newzhezhao.png" alt="" class="tiggerzhezhao">
        <img src="https://yun.yizhidayu.com/66-tiger-person.gif" alt="" class="persongif">
        <!--<img src="https://yun.yizhidayu.com/66-tiger-grayBtn.png" alt="" class="flag">-->
        <img src="https://yun.yizhidayu.com/66-tiger-point.png" alt="" class="flag-static">
        <!--规则内容-->
        <div class="rule_content">
            ...
            <!--规则-->
            <div class="rule" style="background:url(https://yun.yizhidayu.com/66-tiger-rule.png);background-size:100% 100%;background-repeat: no-repeat;">
            </div>
        </div>
        <!--我的奖品-->
        ...
        <!--老虎机按钮-->
        <img src="https://yun.yizhidayu.com/66-tiger-btn.gif" alt="" class="tiggerbtn">
        <img src="https://yun.yizhidayu.com/66-tiger-grayBtn.png" alt="" class="tiggerbtn2">
        <!--底部-->
        <div class="swiper-container" id="swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-pricenew1.png" alt="">
                </div>
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-pricenew2.png" alt="">
                </div>
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-pricenew3.png" alt="">
                </div>
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-pricenew4.png" alt="">
                </div>
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-aplay.png" alt="">
                </div>
                <div class="swiper-slide" style="width:25%;">
                    <img class="photo" src="https://yun.yizhidayu.com/66-tiger-prizegift.png" alt="">
                </div>
            </div>
        </div>
        <!--抽奖文字-->
        <div class="font">
            <p>x<span style="font-weight: bold;"><?php echo ($times); ?></span></p>
        </div>
        <!--次数为0的时候显示的弹窗-->
...
//            alert(arr[index]);
        ...
        //固定活动
        $(".persongif").on("touchend",function(){
            window.location.href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/91";
        })
        $(".rabbit").on("touchend",function(){
            window.location.href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/75";
        })
        ...
        $(".tiggerbtn").on("click",function(){
            ...
            //拉杆拉下来
            $(".flag-static").attr("src","https://yun.yizhidayu.com/66-tiger-twoflag.gif");
            var ttait=setTimeout(function(){
                var flag=$(".flag").html();
                if(flag=="1"){
                    return;
                }else {
        ...
        $('#delete').on("click", function () {
            $(".flag-static").attr("src","https://yun.yizhidayu.com/66-tiger-point.png");
            //白色按钮出现
            $(".tiggerbtn").show();
            $(".tiggerbtn2").hide();
            //移除摇奖
