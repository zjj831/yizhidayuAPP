...
<head>
    ...
    <link rel="stylesheet" href="/Public/Active/56_wenquan/css/index.css">
...
<!--//body-->
<div class="content">
    <section style="background-image:url(https://yun.yizhidayu.com/56-wenquan-bg.jpg);background-size:100% 100%;background-repeat: no-repeat;">
        <a class="one_a" href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/80">
            <img src="https://yun.yizhidayu.com/56-wenquan-one.png" alt="" class="one">
        </a>
        <a class="two_a" href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/73">
            <img src="https://yun.yizhidayu.com/56-wenquan-two.gif" alt="" class="two">
        </a>
        <a class="three_a" href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/81">
            <img src="https://yun.yizhidayu.com/56-wenquan-three.gif" alt="" class="three">
        </a>
        <a class="four_a" href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/72">
            <img src="https://yun.yizhidayu.com/56-wenquan-four.gif" alt="" class="two">
        </a>
        <a class="pai_a" href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/52">
            <img src="https://yun.yizhidayu.com/56-wenquan-pai.gif" alt="" class="pai">
        </a>
