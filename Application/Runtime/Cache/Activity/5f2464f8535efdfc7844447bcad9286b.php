...
<head>
    ...
    <script src='<?php echo C('Public');?>/Active/common/js/jquery.min.js'></script>
    ...
    <link rel="stylesheet" href="/Public/Active/58_dug_Christ/css/demo.css" type="text/css" />
    <link rel="stylesheet" type="text/css" href="/Public/Active/58_dug_Christ/css/sweet-alert.css">
    <link rel="stylesheet" href="/Public/Active/58_dug_Christ/css/index.css">
    <link rel="stylesheet" href="/Public/Active/common/css/swiper.css">
    <script src="/Public/Active/common/js/jquery.fly.min.js"></script>
    <script src="/Public/Active/common/js//swiper.min.js"></script>
    <title><?php echo ($tempInfo['title']); ?></title>
    <!-- Baidu Statistics -->
    <script src="<?php echo C('Public');?>/Active/common/js/baidu-census.js"></script> 
</head>
<body>
    <section class="box" style="background-image:url(https://yun.yizhidayu.com/58-Christ-bg.jpg);background-size:100% 100%;background-repeat: no-repeat;">

        <img class="man" src="https://yun.yizhidayu.com/58-Christ-man.gif" alt="">
        ...
        <section class="dug">
            <div>
                <img class="one" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img  src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
            <div>
                <img class="two" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
            <div>
                <img class="three" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
            <div>
                <img class="four" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
            <div>
                <img class="five" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
            <div>
                <img class="six" src="https://yun.yizhidayu.com/58-Christ-newdug.png" alt="">
                <img src="https://yun.yizhidayu.com/58-Christ-show.png" alt="">
            </div>
        </section>
        <!--//抽奖机会-->
        ...
        <!--//奖品列表-->
        <img src="https://yun.yizhidayu.com/58-Christ-hummer.png" alt="" class="hummer">
        <img src="https://yun.yizhidayu.com/common_price_21.png" alt="" class="price">
        <div class="swiper-container" id="swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/58-Christ-price3.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/58-Christ-price2.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/58-Christ-price1.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/58-Christ-price4.png" alt="">
                </div>
                <!--<div class="swiper-slide">-->
                    <!--<img class="photo" src="https://yun.yizhidayu.com/45-dug-price5.png" alt="">-->
                <!--</div>-->
            </div>
        </div>
        <div class="pop2" style="z-index:100;">
            <div class="velocity">
                ...
                <section class="activetwo">
                    ...
                    <img class="delete deleteajax" src="https://yun.yizhidayu.com/common_pop2_close_21.png" alt="">
                </section>
        ...
        <div class="rule_content">
            ...
            <!--规则-->
            <div class="rule" style="background:url(https://yun.yizhidayu.com/58-Christ-rule.png);background-size:100% 100%;background-repeat: no-repeat;">
            </div>
        </div>
        <!--我的奖品-->
        ...
        <!--浮标-->
        <!--<a class="fubiaoBtn" href="https://www.chipshare.net/dayu/index.php/Activity/Index/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/type/2">-->
            <!--<img id="fubiao" src="https://ow5pnqstl.bkt.clouddn.com/8_fubiao.gif" alt="">-->
        <!--</a>-->
        <!--//跳转页面-->
...
<script>
    ...
    $(".man").on("touchend",function(){
        window.location.href="https://www.yizhidayu.com/index.php/Active/Active/index/media_id/<?php echo ($media_id); ?>/entry_id/<?php echo ($entry_id); ?>/active_id/82";
    })
...
//            alert(arr[index]);
    ...
    $('#delete-three').on("click",function() {
        ...
        $('.dugzhezhao').hide();
        //恢复原状
        $('.dug div img:first-child').attr("src","https://yun.yizhidayu.com/58-Christ-newdug.png");
...
//            $('.dug div img').addClass("jump");
    ...
    //****************************天降红包**********************************************
        ...
        function move1(){
            var t1=setInterval(move1,500);
            function move1(){
                $('.dug div:first-child img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t1);
                });
            }
        }
        ...
        function move22(){
            var t2=setInterval(move2,500);
            function move2(){
                $('.dug div:nth-child(2) img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t2);
                });
            }
        ...
        function move33(){
            var t3=setInterval(move3,500);
            function move3(){
                $('.dug div:nth-child(3) img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t3);
                });
            }
        ...
        function move44(){
            var t4=setInterval(move4,500);
            function move4(){
                $('.dug div:nth-child(4) img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t4);
                });
            }
        ...
        function move55(){
            var t5=setInterval(move5,500);
            function move5(){
                $('.dug div:nth-child(5) img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t5);
                });
            }
        ...
        function move66(){
            var t6=setInterval(move6,500);
            function move6(){
                $('.dug div:nth-child(6) img:first-child').animate({width:"2.75rem","margin-top":"-0.35rem"},"easing",function(){
                    $(this).animate({width:"2.6rem","margin-top":"0rem"});
                    clearInterval(t6);
                });
            }
        ...
        function move (){
            var t1=setTimeout(move1,500);
            var t2=setTimeout(move22,1000);
            var t3=setTimeout(move33,1500);
            var t4=setTimeout(move44,2000);
            var t5=setTimeout(move55,2500);
            var t6=setTimeout(move66,3000);
        }
    //锤子自己动
    ...
    //点击
        $('.dug div img').on("click",function(evt){
            ...
            if(lottNum>0){
                ...
                if($(this).attr("class")=="one"){
                    ...
                    $(".hummer").animate({top:"3.8rem",right:"3rem"},500);
                    ...
                    $(".hummer").animate({top:"6.2rem",right:"3rem"},500);
                }else if($(this).attr("class")=="six"){
                    $(".hummer").animate({top:"6.2rem",right:"0.3rem"},500);
                }
                var time=setTimeout(function(){
                    that.attr("src","https://yun.yizhidayu.com/58-Christ-newsuidug.png");
                },850);
                ajaxone();
            }
        });
        ...
        //点击deleteajax
        $(".deleteajax").on("touchend",function(){
            //可以点击
            $('.dugzhezhao').hide();
            //恢复原状
            $('.dug div img:first-child').attr("src","https://yun.yizhidayu.com/58-Christ-newdug.png");
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status==1){
                        ...
                        $('.jump').attr("data-href",result.href);
                        var t=setTimeout(function(){popshow();},1000)
                    }else if(data.status==0){
                        ajaxzero();
                        return;
                    }
                ...
                success: function success(result) {
                    if(result.status == 0) {
                        ...
                        if(data.length == 1) {
                            ...
                            $('.boxone').attr("href","/index.php/Active/Active/index.html?media_id=<?php echo ($media_id); ?>&entry_id=<?php echo ($entry_id); ?>&active_id="+data[0].id);
                            ...
                            $('.boxone').attr("href","/index.php/Active/Active/index.html?media_id=<?php echo ($media_id); ?>&entry_id=<?php echo ($entry_id); ?>&active_id="+data[0].id);
                            $('.boxtwo').attr("href","/index.php/Active/Active/index.html?media_id=<?php echo ($media_id); ?>&entry_id=<?php echo ($entry_id); ?>&active_id="+data[1].id);
