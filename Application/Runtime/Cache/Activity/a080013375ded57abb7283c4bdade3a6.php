...
<head>
    ...
    <link rel="stylesheet" href="/test/Public/Activity/55_draw_vip/css/index_003.css">
...
<!--//body-->
<div class="content">
    <section style="background-image:url(https://yun.yizhidayu.com/55-draw-bg.jpg);background-size:100% 100%;background-repeat: no-repeat;">
        <!--/****红包雨-->
        <!--提示红包雨信息   -->
        ...
        <img src="https://yun.yizhidayu.com/55-draw-title.png" alt="" class="title">
        <!--规则内容-->
        <div class="rule_content">
            ...
            <!--规则-->
            <div class="rule" style="background:url(https://yun.yizhidayu.com/55-draw-rule.png);background-size:100% 100%;background-repeat: no-repeat;">
            </div>
        </div>
        <!--我的奖品-->
        ...
        <!--/温泉跳转主会场/-->
        <img src="https://yun.yizhidayu.com/common-hotspringone.gif" alt="" class="wenquan_one">
        <!--转盘-->
        <div class="center" style="background:url(https://yun.yizhidayu.com/55-draw-disk1.png);background-size:100% 100%;background-repeat: no-repeat;">
            <div class="center01" style="background:url(https://yun.yizhidayu.com/55-draw-disk2.png);background-size:100% 100%;background-repeat: no-repeat;"></div>
            <img class="position" src="https://yun.yizhidayu.com/55-draw-position.png" alt="">
            <div class="zhuan" style="background:url(https://yun.yizhidayu.com/55-draw-zhuan.png);background-size:100% 100%;background-repeat: no-repeat;"></div>
            <div class="zhen" style="background:url(https://yun.yizhidayu.com/55-draw-btn.png);background-size:100% 100%;background-repeat: no-repeat;"></div>
            <div class="zhen2" style="background:url(https://yun.yizhidayu.com/55-draw-graybtn.png);background-size:100% 100%;background-repeat: no-repeat;"></div>
...
<script>
    window.onload=function() {
        ...
        var t=setTimeout(function(){
            $(".wenquan_one").attr("src","https://yun.yizhidayu.com/common-hotspringtwo.gif");
            clearTimeout(t);
        },1500)
        $(".wenquan_one").on("touchend",function(){
