...
<head>
    ...
    <link rel="stylesheet" href="/test/Public/Activity/65_dug_nai/css/index_001.css">
...
<body>
    <section class="box" style="background-image:url(https://yun.yizhidayu.com/65-dug-nai-bg.jpg);background-size:100% 100%;background-repeat: no-repeat;">
        <!--/****红包雨-->
        ...
        <img src="https://yun.yizhidayu.com/65-dug-person.gif" alt="" class="person">
        <img src="https://yun.yizhidayu.com/65-dug-cakestatic.png" alt="" class="cake">
        <img src="https://yun.yizhidayu.com/65-dug-title.png" alt="" class="title">
        <!--蛋蛋-->
        <section class="dugzhezhao"></section>
        <section class="dug">
            <div>
                <img class="one" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
            <div>
                <img class="two" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
            <div>
                <img class="three" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
            <div>
                <img class="four" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
            <div>
                <img class="five" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
            <div>
                <img class="six" src="https://yun.yizhidayu.com/65-dug-nai-hide.png" alt="">
            </div>
        </section>
        <!--//抽奖机会-->
        <div class="font">
        ...
        <!--//奖品列表-->
        <img src="https://yun.yizhidayu.com/65-dug-hummer.png" alt="" class="hummer">

        <div class="swiper-container" id="swiper">
            <img src="https://yun.yizhidayu.com/65-dug-prize.png" alt="" class="price">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize01.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize02.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize03.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize04.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize05.png" alt="">
                </div>
                <div class="swiper-slide">
                    <img class="photo" src="https://yun.yizhidayu.com/65-dug-prize06.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="zhezhao-three">
            <img class="light-three" src="https://yun.yizhidayu.com/common_light_bg2_21.png" alt="">
        ...
        <div class="rule_content">
            ...
            <!--规则-->
            <div class="rule" style="background:url(https://yun.yizhidayu.com/65-dug-bai-rule.png);background-size:100% 100%;background-repeat: no-repeat;">
            </div>
        </div>
        <!--我的奖品-->
...
//            alert(arr[index]);
    ...
    //****************************天降红包**********************************************
        ...
        function move1(){
            $('.dug div:first-child img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
            var t1=setInterval(move1,300);
            function move1(){
                $('.dug div:first-child img:first-child').animate({},"easing",function(){
                    $(this).attr("src","https://yun.yizhidayu.com/65-dug-nai-hide.png");
                    clearInterval(t1);
                });
            }
        }
        ...
        function move22(){
            $('.dug div:nth-child(3) img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
        ...
        function move33(){
            $('.dug div:nth-child(4) img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
        ...
        function move44(){
            $('.dug div:nth-child(2) img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
        ...
        function move55(){
            $('.dug div:nth-child(6) img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
        ...
        function move66(){
            $('.dug div:nth-child(5) img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-show.png");
    ...
    //点击
        $('.dug div img').on("click",function(evt){
            ...
            if(lottNum>0){
                ...
                var time=setTimeout(function(){
                    that.attr("src","https://yun.yizhidayu.com/65-dug-nai-sui.png");
                },850);
       ...
       //弹窗出现
        ...
        $('#delete').on("click",function(){
            ...
            $('.dugzhezhao').hide();
            //恢复原状
            $('.dug div img:first-child').attr("src","https://yun.yizhidayu.com/65-dug-nai-hide.png");
            ...
            if(num_fubiao==0){
                ...
                $(".cake").show().addClass("trans");
                var t=setTimeout(function(){
                    $(".cake").attr("src","https://yun.yizhidayu.com/65-dug-nai-cake.gif");
                    clearTimeout(t);
                },2200);
                var t2=setTimeout(function(){
                    $(".cake").attr("src","https://yun.yizhidayu.com/65-dug-nai-rabbit.gif");
                    clearTimeout(t2);
                },4200);
