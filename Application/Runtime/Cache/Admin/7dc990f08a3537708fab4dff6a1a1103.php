            ...
            <div  class="">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo U('Active/coupon_edit_save');?>"  enctype="multipart/form-data">
                            <div class="box-body">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($couponInfo['weight']); ?>" id="weight" name="weight" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">类型:</label>
                                    <div class="col-sm-10">
                                        <input value="<?php echo ($couponInfo['type']); ?>" id="coupontype" type="hidden">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10" style="width:100px;height:100px;border:1px solid #ccc;position:relative;">
                                        ...
                                        <input id="imgurl" type="hidden" class="form-control" name="imgurl" value="<?php echo ($couponInfo['icon']); ?>" placeholder="">
                                        <img id="img" style="width:100px;height:100px;position:absolute;top:0;left:0;" src="<?php echo ($couponInfo['icon']); ?>" alt="">
                                    </div>
                                </div>
                                <!--<div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10" style="width:100px;height:100px;border:1px solid #ccc;position:relative;">
                                        <input type="hidden" value="<?php echo ($couponInfo['id']); ?>" name="id" id="id2">
                                        ...
                                        <input id="imgurl2"  type="hidden" class="form-control" name="imgurl2" value="<?php echo ($couponInfo['pic']); ?>" placeholder="">
                                        <img id="img2" style="width:100px;height:100px;position:absolute;top:0;left:0;" src="<?php echo ($couponInfo['pic']); ?>" alt="">
                                    </div>
                                </div>-->
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"value="<?php echo ($couponInfo['pic']); ?>"  name="imgurl2"  id="imgurl2" placeholder="填写图片链接">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"value="<?php echo ($couponInfo['title']); ?>"  name="title"  id="title" placeholder="后台标题名称,主要用于管理">
                                    </div>
                                </div>
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control"value="<?php echo ($couponInfo['name']); ?>"  name="name"  id="name" placeholder="例:浪漫之夏手链优惠券">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="href" name="href" value="<?php echo ($couponInfo['href']); ?>"  placeholder="如 https://www.yizhidayu.com">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="price" name="price"  value="<?php echo ($couponInfo['price']); ?>"  placeholder="例:3元/A单价">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($couponInfo['total']); ?>" id="total" name='total' placeholder="请填写优惠券金额">
                                    </div>
                      	...
                      	*
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="<?php echo ($couponInfo['system']); ?>" id="couponsystem" type="hidden">
                      	...
                      	*
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo ($couponInfo['daily_limit']); ?>" id="daily_limit" name="daily_limit"  placeholder="">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($couponInfo['full_limit']); ?>" id="full_limit" name="full_limit"  placeholder="">
                                        <div class="tip">0为不限制</div>
                                    </div>
                                </div>
                               <!-- <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($couponInfo['catch_day_limit']); ?>" id="catch_day_limit" name="catch_day_limit"  placeholder="">
                                        <div class="tip">0为不限制</div>
                                    </div>
                                </div>-->
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($couponInfo['catch_limit']); ?>" id="catch_limit" name="catch_limit"  placeholder="">
                                        <div class="tip">0为不限制</div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php if($couponInfo['status'] == 1): ?><input type="radio" name="status" value="1" checked="checked"><label for="">上架</label>
                                            <input type="radio" name="status" value="0"><label for="">下架</label>
                                            <?php elseif($couponInfo['status'] == 0): ?>
                                            <input type="radio" name="status" value="1" ><label for="">上架</label>
                                            <input type="radio" name="status" value="0" checked="checked"><label for="">下架</label><?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php if($couponInfo['status'] == 1): ?><input type="radio" name="isalone" value="1" checked="checked"><label for="">是</label>
                                            <input type="radio" name="isalone" value="2"><label for="">否</label>
                                            <?php elseif($couponInfo['status'] == 2): ?>
                                            <input type="radio" name="isalone" value="1" ><label for="">是</label>
                                            <input type="radio" name="isalone" value="2" checked="checked"><label for="">否</label><?php endif; ?>
                                    </div>
                                </div>
