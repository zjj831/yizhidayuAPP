            ...
            <div  class="">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo U('Coupon/addcate');?>" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label" title="必填">分类名称 <span id=""  style="color: red;">
                      	*
                      </span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="name" class="form-control" name="title" id="inputPassword3" placeholder="">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label" title="必填">所属分类<span id=""  style="color: red;">
                      	*
                      </span> </label>
                                    <div class="col-sm-10">
                                        <select name="pid" id="pid">
                                            <option value="0">一级分类</option>
                                            <?php if(is_array($pcate)): foreach($pcate as $key=>$item): ?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
