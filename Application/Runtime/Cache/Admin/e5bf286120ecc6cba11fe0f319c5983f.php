...
<form class="form-horizontal" method="post" action="<?php echo U('Coupon/createstore');?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="file" class="form-control" name="img[]" id="inputEmail3" placeholder="">
                      </div>
                    </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" name="link" id="inputPassword3" placeholder="">
                          </div>
                      </div>
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control" name="description" id="inputPassword3" placeholder="">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" class="form-control" name="style" id="inputPassword3" placeholder="">
                      </div>
                  </div>
                      ...
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <input  type="text" id="datepicker" name="enddate" data-provide="datepicker" placeholder="结束时间" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <select style="width:30%;float:left;margin-left:15px;"  id="m" name="cate1" class="select form-control">
                              ...
                              <?php if(is_array($pcate)): foreach($pcate as $key=>$v1): ?><option value="<?php echo ($v1["id"]); ?>"><?php echo ($v1["title"]); ?></option><?php endforeach; endif; ?>
                          </select>
                      ...
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <select style="width:30%;float:left;margin-left:15px;"  name="catetwo" class="select form-control">
                              ...
                              <?php if(is_array($cateid2)): foreach($cateid2 as $key=>$v1): ?><option value="<?php echo ($v1["id"]); ?>"><?php echo ($v1["title"]); ?></option><?php endforeach; endif; ?>
                          </select>
                      ...
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <textarea  cols="75" rows="5" name="introduce"> </textarea>
                          </div>
                      </div>
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <textarea  cols="75" rows="5" name="useexp"> </textarea>
                         </div>
                      </div>
                      <div class="form-group">
                      	...
                      	*
                          ...
                          <div class="col-sm-10">
                              <textarea  cols="75" rows="5" name="receiveexp"> </textarea>
                          </div>
                      </div>
