            ...
            <div  class="">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo U('Coupon/addcate2');?>" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label" title="必填">分区名称 <span id=""  style="color: red;">
                      	*
                      </span></label>
                                    <div class="col-sm-10">
