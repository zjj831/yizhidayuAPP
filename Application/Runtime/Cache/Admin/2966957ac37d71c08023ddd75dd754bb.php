            ...
            <div  class="">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-1">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo U('Active/active_edit_save');?>"  enctype="multipart/form-data">
                            <div class="box-body">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($activeInfo['weight']); ?>" id="weight" name="weight" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10" style="width:100px;height:100px;border:1px solid #ccc;position:relative;">
                                        <input type="hidden" value="<?php echo ($activeInfo['id']); ?>" name="id" id="id">
                                        ...
                                        <input id="imgurl" type="hidden" class="form-control" name="imgurl" value="<?php echo ($activeInfo['icon']); ?>" placeholder="">
                                        <img id="img" style="width:100px;height:100px;position:absolute;top:0;left:0;" src="<?php echo ($activeInfo['icon']); ?>" alt="">
                                    </div>
                                </div>
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10" style="width:100px;height:100px;border:1px solid #ccc;position:relative;">
                                        ...
                                        <input id="imgurl2"  type="hidden" class="form-control" name="imgurl2" value="<?php echo ($activeInfo['pic']); ?>" placeholder="">
                                        <img id="img2" style="width:100px;height:100px;position:absolute;top:0;left:0;" src="<?php echo ($activeInfo['pic']); ?>" alt="">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="<?php echo ($activeInfo['title']); ?>"  name="title"  id="title" placeholder="例：星巴克转盘">
                                    </div>
                                </div>
                                <div class="form-group">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="temp" name="temp" value="<?php echo ($activeInfo['temp']); ?>"  placeholder="例：01_draw_star">
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="8" id="times" name='times' value="<?php echo ($activeInfo['times']); ?>" placeholder="请输入活动次数">
                                    </div>
                                </div>
                      	...
                      	*
                                    ...
                                    <div class="col-sm-10">
                                        <input  type="text" class="form-control"  id="determine" name="determine" value="<?php echo ($activeInfo['determine']); ?>"  placeholder="例：3000">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <?php if($activeInfo['status'] == 1): ?><input type="radio" name="status" value="1" checked="checked"><label for="">上架</label>
                                            <input type="radio" name="status" value="2"><label for="">下架</label>
                                            <?php elseif($activeInfo['status'] == 2): ?>
                                            <input type="radio" name="status" value="1" ><label for="">上架</label>
                                            <input type="radio" name="status" value="2" checked="checked"><label for="">下架</label><?php endif; ?>
